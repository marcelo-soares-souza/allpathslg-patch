...
public:
  ...
  explicit MapOfCounters( A const& a ) : BaseT(std::less<size_t>(),a) {}
  MapOfCounters( MapOfCounters const& that )=default;
  MapOfCounters( MapOfCounters const& that, A const& a )
    : BaseT(std::less<size_t>(),a) {
    *this = that;
  }
...
{
public:
  KmerFrequencyCounters()=default;
  KmerFrequencyCounters( A const& a ) : MapOfCounters(a) {}
  KmerFrequencyCounters( KmerFrequencyCounters const& that )=default;
  KmerFrequencyCounters( KmerFrequencyCounters const& that,
                         A const& a ) : MapOfCounters(that,a) {}
