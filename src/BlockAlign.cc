 ...
 * Constructor
 */
block_align::block_align( const allpathslg::align  *al, const vec<int> *mut )
{
  this->Setup( al, mut );
}
 ...
 * SetFromAlign
 */
void block_align::SetFromAlign( const allpathslg::align  *al, const vec<int> *mut )
{
  this->Setup( al, mut );
}
 ...
 * Setup
 */
void block_align::Setup( const allpathslg::align  *al, const vec<int> *mut )
{
  if ( mut )
