    ...
    const digraphE<F>& c )
{
  ...
  ForceAssertGe( a.NVertices( ), 2 );
  ForceAssertGe( b.NVertices( ), 2 );
  ...
  ForceAssertEq( EE.front( ), 0 );
  ForceAssertEq( EE.back( ), c.N( ) - 1 );
  ForceAssertEq( FF.front( ), 0 );
  ForceAssertEq( FF.back( ), c.N( ) - 1 );
