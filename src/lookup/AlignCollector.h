...
public:
  ...
  /// Sets the size of the collector to i and initializes "best errors" to
  /// "infinitely many" (only for newly added elements!).
  virtual void resize(unsigned int i) {
    best_.resize(i, infinitely_many);
  }
  ...
  /// Reimplemented by unique align  collectors.
  virtual bool AlignsWanted(unsigned int query_id) const {
    return true;
  }
  ...
  virtual bool AmAmbiguousCollector() const {
    return false;
  }
  virtual bool IsAmbiguous(int query_id) const {
    return false;
  }
  ...
  static const char *GetCollectorName() {
    return "AlignCollectorBase";
  }
...
public:
  ...
  static const char *GetCollectorName() {
    return "MaxErrDiffAlignCollector";
  }
...
public:
  ...
  int Size(int query_id) const {
    return UniquelyAligned(query_id);
  }
  ...
  static const char *GetCollectorName() {
    return "UniqueByErrDiffAlignCollector";
  }
...
public:
  ...
  static const char *GetCollectorName() {
    return "BestNextBestAlignCollector";
  }
...
/// not implemented for this collector; will print error message and crash.
  const look_align & Align(unsigned int i) const {
    cout << "AmbiguousAlignCollector::Align() is not implemented" << endl;
    ForceAssert(0);
    look_align* la = new look_align;
    return *la;
  }
/// not implemented for this collector; will print error message and crash.
  look_align & MutableAlign(unsigned int i) const {
    cout << "AmbiguousAlignCollector::MutableAlign() is not implemented" << endl;
    ForceAssert(0);
    look_align* la = new look_align;
    return *la;
  }
...
/// not implemented for this collector; will print error message and crash.
  void Erase(int id) {
    cout << "AmbiguousAlignCollector::Erase() is not implemented" << endl;
    ForceAssert(0);
  }
/// not implemented for this collector; won't do anything
  void AdjustQueryIds(int offset) {};
...
/// Erases all elements of this collector (size will be 0!)
  ...
  bool AmAmbiguousCollector() const {
    return true;
  }
...
// Use align  to test read for ambiguity, add align  if needed
  ...
  void SetAsAmbiguous(int query_id) {
    counts_per_read_[query_id] = num_better_aligns_;
  }

  int MinErrors(int query_id) const {
    return best_[query_id];
  }
...
// Print ambiguous for all query_ids
  ...
  static const char *GetCollectorName() {
    return "AmbiguousAlignCollector";
  }
