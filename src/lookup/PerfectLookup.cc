...
LockedData PerfectLookupProcessor2::LOCK_FL;
...
{    
     ...
     parallelFor(0,start_id.isize(),PerfectLookupProcessor1(),max_threads);
     ...
     {    lookp->ReadChunk(i);
          ...
          parallelFor(0,start_id.isize(),PerfectLookupProcessor2(),max_threads); }
