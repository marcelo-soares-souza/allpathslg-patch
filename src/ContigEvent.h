...
Bool ContigOperator( ) const {
  return True;
}
Bool LinkCreationOperator( ) const {
  return False;
}
Bool ReverseLinkOperator( ) const {
  return False;
}
...
void Print( ostream& out ) const {
  out << "start MergeContigsWithGaps\n";
}
