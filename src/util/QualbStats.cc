...
public:
  ...
  float    q_eff() {
    return effective_qual_from_freqs(_q_base_freqs);
  }
  float    q_mean() {
    return mean_from_freqs(_q_base_freqs);
  }
  float    q_min() {
    return min_from_freqs(_q_base_freqs);
  }
  float    q_max() {
    return max_from_freqs(_q_base_freqs);
  }
  unsigned q_Q1()  {
    return quantile_from_freqs(_q_base_freqs, 0.25);
  }
  unsigned q_Q2()  {
    return quantile_from_freqs(_q_base_freqs, 0.50);
  }
  unsigned q_Q3()  {
    return quantile_from_freqs(_q_base_freqs, 0.75);
  }
