...
// array of mutmer_read_idY's, stored as a vec; it might be possible to optimize for
// speed the way in which memory is allocated for the mutmer_read_idYs.
//
...
template<int I = 1> class mutmer_read_idY
{
private:
