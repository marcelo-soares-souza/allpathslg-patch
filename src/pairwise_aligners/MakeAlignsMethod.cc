...
public:
  ...
  void SetMutmerId( int mutmer_id ) {
    mm_id_ = mutmer_id;
  }
  void SetIsBegin( begin_or_end which_end ) {
    which_ = which_end;
  }
...
public:
  ...
  int BeginOnSeq1() const {
    return start_on_seq1_;
  }
  int EndOnSeq1() const {
    return start_on_seq1_ + length_;
  }
  int BeginOnSeq2() const {
    return start_on_seq2_;
  }
  int EndOnSeq2() const {
    return start_on_seq2_ + length_;
  }
  int SumMutmerLengths() const {
    return sum_mutmer_lens_;
  }
  int MaxMutmerLength() const {
    return max_mutmer_len_;
  }
