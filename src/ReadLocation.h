...
public:
  ...
  unsigned int LengthOfRead( ) const {
    return length_of_read_;
  }
  ...
  int StopOnContig( ) const {
    return start_on_contig_ + length_of_read_ - 1;
  }
  int Start( ) const {
    return start_on_contig_;
  }
  int RcStart( ) const {
    return LengthOfContig( ) - Start( ) - LengthOfRead( );
  }
  int Stop( ) const {
    return start_on_contig_ + length_of_read_ - 1;
  }
  ...
  orientation OrientationOnContig( ) const {
    return orientation_on_contig_;
  }
  Bool Fw( ) const {
    return orientation_on_contig_ == ForwardOr;
  }
  Bool Rc( ) const {
    return orientation_on_contig_ == ReverseOr;
  }
  orient_t Orient() const {
    return Fw() ? ORIENT_FW : ORIENT_RC;
  }
  int LengthOfContig( ) const {
    return length_of_contig_;
  }

  Bool OnSupers( ) const {
    return on_supers_;
  }
  short SuperContig( ) const {
    return super_contig_;
  }
  int StartOnSuperContig( ) const {
    return start_on_supercontig_;
  }
  int StopOnSuperContig( ) const
  {
    return start_on_supercontig_ + length_of_read_ - 1;
  }
  int LengthOfSuperContig( ) const {
    return length_of_supercontig_;
  }

  void SetReadId( int r ) {
    read_id_ = r;
  }
  void SetLengthOfRead( int l ) {
    length_of_read_ = l;
  }
  void SetContig( int c ) {
    contig_ = c;
  }
  void SetLengthOfContig( int l ) {
    length_of_contig_ = l;
  }
  void SetLengthOfSuperContig( int l ) {
    length_of_supercontig_ = l;
  }
  void SetOrientationOnContig( orientation o ) {
    orientation_on_contig_ = o;
  }
  void SetStartOnContig( int s ) {
    start_on_contig_ = s;
  }
  void AddToStart( int a ) {
    start_on_contig_ += a;
  }
  void SetStartOnSuperContig( int s ) {
    start_on_supercontig_ = s;
  }
  void SetOnSupers( Bool v ) {
    on_supers_ = v;
  }
...
public:
  ...
  void SetReadId( read_id_t new_id ) {
    read_id_ = new_id;
  }
