...
public:
  ...
  static void UseOneLineOutput() {
    s_displayMode = ONE_LINE;
  }
  static void UseSplitLineOutput() {
    s_displayMode = SPLIT;
  }
...
public:
  ...
  const pp_read& Left( ) const {
    return left_;
  }
  const pp_read& Right( ) const {
    return right_;
  }
  pp_read& LeftMutable( ) {
    return left_;
  }
  pp_read& RightMutable( ) {
    return right_;
  }
  int LeftSize( ) const {
    return left_.size( );
  ...
  void SetLeft( const pp_read& p ) {
    left_ = p;
  }
  void SetRight( const pp_read& p ) {
    right_ = p;
  }
...
public:
  ...
  void SetLeftMark( int m ) {
    left_mark_ = m;
  }
  void SetRightMark( int m ) {
    right_mark_ = m;
  }
