...
public:
  ...
  double f0(double t) const {
    return seekArray(t, d0);
  }
  double f1(double t) const {
    return seekArray(t, d1);
  }
  double f2(double t) const {
    return seekArray(t, d2);
  }

  // the implementation of virtual methods
  double p0(double t) const {
    return seekArray(t, p);
  }
  double f0(double t1,double t2) const {
    return f0(t2) - f0(t1);
  }
  double f1(double t1,double t2) const {
    return f1(t2) - f1(t1);
  }
  double f2(double t1,double t2) const {
    return f2(t2) - f2(t1);
  }
  double Avg() const {
    return avg;
...
public:
  ...
  double f0(double t) const {
    return seekArray(t, dist0);
  }
  double f1(double t) const {
    return seekArray(t, dist1);
  }
  double f2(double t) const {
    return seekArray(t, dist2);
  }

  // the implementation of virtual methods
  double p0(double t) const {
    return seekArray(t, dist);
  }
  double f0(double t1,double t2) const {
    return f0(t2) - f0(t1);
  }
