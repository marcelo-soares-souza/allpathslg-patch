...
public:
  ...
  const vec<int>& Path( const int i ) const {
    return paths_[i];
  }
  vec<int>& PathMutable( const int i ) {
    return paths_[i];
  }
  int Path( const int i, const int j ) const {
    return paths_[i][j];
  }
  int& PathMutable( const int i, const int j ) {
    return paths_[i][j];
  }
  const vec< vec<int> >& Paths( ) const {
    return paths_;
  }
  vec< vec<int> >& PathsMutable( ) {
    return paths_;
  }

  fix64_6 WeightFw( int i ) const {
    return weights_fw_[i];
  }
  ...
  fix64_6& WeightFwMutable( const int i ) {
    return weights_fw_[i];
  }
  const vec<fix64_6>& WeightsFw( ) const {
    return weights_fw_;
  }
  vec<fix64_6>& WeightsFwMutable( ) {
    return weights_fw_;
  }
  fix64_6 WeightRc( int i ) const {
    return weights_rc_[i];
  }
  ...
  fix64_6& WeightRcMutable( const int i ) {
    return weights_rc_[i];
  }
  const vec<fix64_6>& WeightsRc( ) const {
    return weights_rc_;
  }
  vec<fix64_6>& WeightsRcMutable( ) {
    return weights_rc_;
  }
  fix64_6 Weight( int i ) const {
    return weights_fw_[i] + weights_rc_[i];
  }
  ...
  Pair( const int i ) const {
    return pairs_[i];
  }
  pair< vec<int>, vec<int> >& PairMutable( const int i ) {
    return pairs_[i];
  }
  const vec<int>& PairLeft( int i ) const {
    return pairs_[i].first;
  }
  vec<int>& PairLeftMutable( int i ) {
    return pairs_[i].first;
  }
  const vec<int>& PairRight( int i ) const {
    return pairs_[i].second;
  }
  vec<int>& PairRightMutable( int i ) {
    return pairs_[i].second;
  }
  int PairLeft( const int i, const int j ) const {
    return pairs_[i].first[j];
  }
  int& PairLeftMutable( const int i, const int j ) {
    return pairs_[i].first[j];
  }
  int PairRight( const int i, const int j ) const {
  ...
  const vec< pair< vec<int>, vec<int> > >& Pairs( ) const {
    return pairs_;
  }
  vec< pair< vec<int>, vec<int> > >& PairsMutable( ) {
    return pairs_;
  }

  const vec< vec<pair_point> >& PairData( ) const {
    return pair_data_;
  }
  vec< vec<pair_point> >& PairDataMutable( ) {
    return pair_data_;
  }
  const vec<pair_point>& PairData( const int i ) const {
    return pair_data_[i];
  }
  vec<pair_point>& PairDataMutable( const int i ) {
    return pair_data_[i];
  }
  ...
  int Inv( const int x ) const {
    return inv_[x];
  }
  int& InvMutable( const int x ) {
    return inv_[x];
  }
  const vec<int>& Inv( ) const {
    return inv_;
  }
  vec<int>& InvMutable( ) {
    return inv_;
  }
  Bool InvDef( const int x ) const {
    return inv_[x] != -1;
  }
  ...
  int64_t& ReadCountMutable( ) {
    return nreads_;
  }
  int MedianCorrectedReadLength( ) const {
    return read_length_dist_.median( );
  }
  int MedianCorrectedReadLengthFudge( ) const
  {
    return int( round( read_length_dist_.median( ) * 1.0 ) );
  }
  const IntDistribution& ReadLengthDist( ) const {
    return read_length_dist_;
  }
  IntDistribution& ReadLengthDistMutable( ) {
    return read_length_dist_;
  }
  double FudgeMult( ) const {
    return fudge_mult_;
  }
  double& FudgeMultMutable( ) {
    return fudge_mult_;
  }
