...
public:
  ...
  static int const* begin() {
    return gK;
  }
  static int const* end() {
    return gK+sizeof(gK)/sizeof(gK[0]);
  }
  ...
  static void dispatch( int k, Args&&... args )
  {
    ...
    {
    case gK[0]:
      C<gK[0]>()(std::forward<Args>(args)...);
      break;
    case gK[1]:
      C<gK[1]>()(std::forward<Args>(args)...);
      break;
    case gK[2]:
      C<gK[2]>()(std::forward<Args>(args)...);
      break;
    case gK[3]:
      C<gK[3]>()(std::forward<Args>(args)...);
      break;
    case gK[4]:
      C<gK[4]>()(std::forward<Args>(args)...);
      break;
    case gK[5]:
      C<gK[5]>()(std::forward<Args>(args)...);
      break;
    case gK[6]:
      C<gK[6]>()(std::forward<Args>(args)...);
      break;
    case gK[7]:
      C<gK[7]>()(std::forward<Args>(args)...);
      break;
    case gK[8]:
      C<gK[8]>()(std::forward<Args>(args)...);
      break;
    case gK[9]:
      C<gK[9]>()(std::forward<Args>(args)...);
      break;
    case gK[10]:
      C<gK[10]>()(std::forward<Args>(args)...);
      break;
    case gK[11]:
      C<gK[11]>()(std::forward<Args>(args)...);
      break;
    case gK[12]:
      C<gK[12]>()(std::forward<Args>(args)...);
      break;
    case gK[13]:
      C<gK[13]>()(std::forward<Args>(args)...);
      break;
    case gK[14]:
      C<gK[14]>()(std::forward<Args>(args)...);
      break;
    case gK[15]:
      C<gK[15]>()(std::forward<Args>(args)...);
      break;
    case gK[16]:
      C<gK[16]>()(std::forward<Args>(args)...);
      break;
    case gK[17]:
      C<gK[17]>()(std::forward<Args>(args)...);
      break;
    case gK[18]:
      C<gK[18]>()(std::forward<Args>(args)...);
      break;
    case gK[19]:
      C<gK[19]>()(std::forward<Args>(args)...);
      break;
    case gK[20]:
      C<gK[20]>()(std::forward<Args>(args)...);
      break;
    case gK[21]:
      C<gK[21]>()(std::forward<Args>(args)...);
      break;
    case gK[22]:
      C<gK[22]>()(std::forward<Args>(args)...);
      break;
    case gK[23]:
      C<gK[23]>()(std::forward<Args>(args)...);
      break;
    case gK[24]:
      C<gK[24]>()(std::forward<Args>(args)...);
      break;
    case gK[25]:
      C<gK[25]>()(std::forward<Args>(args)...);
      break;
    case gK[26]:
      C<gK[26]>()(std::forward<Args>(args)...);
      break;
    case gK[27]:
      C<gK[27]>()(std::forward<Args>(args)...);
      break;
    case gK[28]:
      C<gK[28]>()(std::forward<Args>(args)...);
      break;
    default:
      FatalErr("Illegal value " << k << " for K in BigK dispatcher.");
    }
  }
};
