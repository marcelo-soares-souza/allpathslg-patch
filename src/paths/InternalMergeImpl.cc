...
public:
  ...
  int PosOnInterval( ) const {
    return pos_on_interval_;
  }
  int PosOnPath( ) const {
    return pos_on_path_;
  }
...
public:
  ...
  int SegmentOnEdge( ) const {
    return segment_on_edge_;
  }
  int KmerOnSegment( ) const {
    return kmer_on_segment_;
  }
  ...
  void SetSegmentOnEdge( int s ) {
    segment_on_edge_ = s;
  }
  void SetKmerOnSegment( int k ) {
    kmer_on_segment_ = k;
  }

  void AddToSegmentOnEdge( int a ) {
    segment_on_edge_ += a;
  }
...
public:
  ...
  const EmbeddedSubPath<KmerPath>& Path1( ) const {
    return a1_;
  }
  const EmbeddedSubPath<KmerPath>& Path2( ) const {
    return a2_;
  }
  ...
  const MultiKmerPathLoc& Loc1( ) const {
    return l1_;
  }
  const MultiKmerPathLoc& Loc2( ) const {
    return l2_;
  }
...
public:
  ...
  Bool Initialized( ) const {
    return intervals_to_left_ >= 0;
  }

  int IntervalsToLeft( ) const {
    return intervals_to_left_;
  }
  int KmersInPartialToLeft( ) const {
    return kmers_in_partial_to_left_;
  }

  void SetIntervalsToLeft( int x ) {
    intervals_to_left_ = x;
  }
...
public:
  ...
  int FromIndex1( ) const {
    return from_index1_;
  }
  int FromIndex2( ) const {
    return from_index2_;
  }
  int To1( ) const {
    return to1_;
  ...
  KmerPathLocAlt Pos1( ) const {
    return l1_;
  }
  KmerPathLocAlt Pos2( ) const {
    return l2_;
  }
  int Offset( ) const {
    return l1_.PosOnPath( ) - l2_.PosOnPath( );
  }
                   ...
                   const NegativeGapValidator* ngv, bool calculate_ij = false )
{
       ...
       !p.Path1( ).EdgeObject( p.Path1( ).NEdges( ) ).LastSegment( ).isGap( ) )
  {
    ...
    i.resize( p.Path1( ).NVertices( ) );
    j.resize( p.Path2( ).NVertices( ) );
    int sum = 0;
...
public:
  ...
  const PointedSubPathPair& PathPair( ) const {
    return p_;
  }
  ...
  const vec< pair<MultiKmerPathLoc,MultiKmerPathLoc> >& Ends( ) const {
    return ends_;
  }
  const pair<MultiKmerPathLoc,MultiKmerPathLoc>& Ends(int i) const {
    return ends_[i];
  }

  int AlignLength( ) const {
    return align_length_;
  }
  ...
  void SetTerminal( const Bool term = True ) {
    terminal_ = term;
  }
