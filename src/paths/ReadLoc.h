...
public:
  ...
  uint64_t getReadID() const {
    return mReadID;
  }
  int32_t getContigPosn() const {
    return mContigPosn;
  }
  bool isRC() const {
    return mIsRC;
  }
  bool partnerIsRC() const {
    return mPartnerIsRC;
  }
  uint16_t getReadLen() const {
    return mReadLen;
  }
  uint8_t getBandwidth() const {
    return mBandwidth;
  }
  uint64_t getPartnerReadID() const {
    return mPartnerReadID;
  }
  uint32_t getPartnerContigID() const {
    return mPartnerContigID;
  }
  int32_t getPartnerContigPosn() const {
    return mPartnerContigPosn;
  }
  bool PartnerisRC() const {
    return mPartnerIsRC;
  }
  uint16_t getPartnerReadLen() const {
    return mPartnerReadLen;
  }
  uint8_t getPartnerBandwidth() const {
    return mPartnerBandwidth;
  }
  uint8_t getReadClass() const {
    return mReadClass;
  }
  uint8_t getLibID() const {
    return mLibID;
  }
  bool partnerPlaced() const {
    return mPartnerPlaced;
  }
...
public:
  ...
  bool PartnerPlaced( ) const {
    return partner_placed_;
  }
  void SetPartnerPlaced( ) {
    partner_placed_ = true;
  }
  uint64_t PartnerReadId( ) const {
    return partner_read_id_;
  }
  void SetReadId( const uint64_t read_id) {
    read_id_ = read_id;
  }
  ...
  uint32_t ContigId( ) const {
    return contig_id_;
  }
  uint32_t PartnerContigId( ) const {
    return partner_contig_id_;
  }
  ...
  int32_t Start( ) const {
    return pos_on_contig_;
  }
  int32_t PartnerStart( ) const {
    return partner_pos_on_contig_;
  }
  ...
  int32_t Stop( ) const {
    return pos_on_contig_ + read_length_;
  }
  ...
  bool Fw( ) const {
    return fw_on_contig_;
  }
  bool Rc( ) const {
    return !fw_on_contig_;
  }
  bool PartnerFw( ) const {
    return partner_fw_on_contig_;
  }
  void SetPartnerFw( const bool partner_fw_on_contig )
  {
    partner_fw_on_contig_ = partner_fw_on_contig;
  }
  bool PartnerRc( ) const {
    return !partner_fw_on_contig_;
  }
  uint8_t LibraryId( ) const {
    return library_id_;
  }
  uint16_t ReadLength( ) const {
    return read_length_;
  }
  uint16_t PartnerReadLength( ) const {
    return partner_read_length_;
  }
  ...
  uint8_t PartnerBandwidth( ) const {
    return partner_bandwidth_;
  }
  ...
  uint64_t PseudoPairId( ) const {
    return Min( ReadId( ), PartnerReadId( ) );
  }
