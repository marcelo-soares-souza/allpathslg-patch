                                 ...
                                 vec< vec<int> > & nexts )
{
  switch ( K ) {
  case 16:
    GetNexts<16>( unibases, nexts );
    break;
  case 20:
    GetNexts<20>( unibases, nexts );
    break;
  case 40:
    GetNexts<40>( unibases, nexts );
    break;
  case 60:
    GetNexts<60>( unibases, nexts );
    break;
  case 64:
    GetNexts<64>( unibases, nexts );
    break;
  case 80:
    GetNexts<80>( unibases, nexts );
    break;
  case 88:
    GetNexts<88>( unibases, nexts );
    break;
  case 96:
    GetNexts<96>( unibases, nexts );
    break;
  case 128:
    GetNexts<128>( unibases, nexts );
    break;
  case 144:
    GetNexts<144>( unibases, nexts );
    break;
  case 192:
    GetNexts<192>( unibases, nexts );
    break;
  case 200:
    GetNexts<200>( unibases, nexts );
    break;
  case 400:
    GetNexts<400>( unibases, nexts );
    break;
  case 640:
    GetNexts<640>( unibases, nexts );
    break;
