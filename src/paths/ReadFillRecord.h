...
public:
  ...
  int FirstFilling() const {
    return first_filling;
  }
  int LastFilling() const {
    return first_filling + num_fillings - 1;
  }
  int NumFillings() const {
    return num_fillings;
  }
  bool Exploded() const {
    return exploded;
  }
  bool HitMergerLimit() const {
    return merger_limit;
  }

  void SetFirstFilling(int first) {
    first_filling = first;
  }
  void SetNumFillings(int num) {
    num_fillings = num;
  }
  void SetExploded(bool expl) {
    exploded = expl;
  }
  void SetHitMergerLimit(bool merg) {
    merger_limit = merg;
  }
