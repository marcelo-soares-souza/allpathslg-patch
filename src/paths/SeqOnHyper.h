...
public:
  ...
  void Setpos1( int pos1 ) {
    pos1_ = pos1;
  }
  void Setpos2( int pos2 ) {
    pos2_ = pos2;
  }
  void SetId2( longlong id2 ) {
    id2_ = id2;
  }
  void SetLen( int len ) {
    len_ = len;
...
public:
  ...
  int Len1( ) const {
    return parts_.back( ).Pos1( );
  }
  int pos1( int i ) const {
    return parts_[i].pos1( );
  }
  int Pos1( int i ) const {
    return parts_[i].Pos1( );
  }
  int pos2( int i ) const {
    return parts_[i].pos2( );
  }
  int Pos2( int i ) const {
    return parts_[i].Pos2( );
  }
  ...
  void SetRc1( Bool rc1 ) {
    rc1_ = rc1;
  }
  void SetId1( longlong id1 ) {
    id1_ = id1;
  }

  PartialSeqOnHyper& Part( int i ) {
    return parts_[i];
  }
  const PartialSeqOnHyper& Part( int i ) const {
    return parts_[i];
  }
...
public:
  ...
  longlong Id1() const {
    return ((m_idrc1 < 0) ? -m_idrc1-1 : m_idrc1);
  }
  Bool Rc1() const {
    return (m_idrc1 < 0);
  }
  const PartialSeqOnHyper& Part0() const {
    return m_first_edge_alignment;
  }
...
private:
  ...
  static void IncrementAmbigCount() {
    ambig_count++;
  }
public:
  static void ClearAmbigCount() {
    ambig_count = 0;
  }
  static longlong AmbigCount() {
    return ambig_count;
  }
...
private:
  ...
  void SetIdRc1( longlong id1, bool rc1 ) {
    m_idrc1 = (rc1 ? -id1-1 : id1 );
  }
