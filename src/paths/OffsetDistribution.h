...
public:
  ...
  bool aligns()         const {
    return (_aligned == 1 || _aligned == 2);
  }
  bool aligns_tig1()    const {
    return (_aligned == 1);
  }
  bool aligns_tig2()    const {
    return (_aligned == 2);
  }
  ...
  int  read_length()    const {
    return (is_forward()) ? _j1 - _j0 + 1 : _j0 - _j1 + 1;
  }
  int  tig()            const {
    return _aligned;
  }
...
public:
  ...
  int size_contig1() const {
    return _sz_tig1;
  }
  int size_contig2() const {
    return _sz_tig2;
  }
  ...
  int size_fw_read() const {
    return _fw.read_length();
  }
  int size_bw_read() const {
    return _bw.read_length();
  }
  ...
  bool aligns_fw() const {
    return _fw.aligns();
  }
  bool aligns_bw() const {
    return _bw.aligns();
  }

  bool aligns_fw0() const {
    return !_fw.aligns();
  }
  bool aligns_bw0() const {
    return !_bw.aligns();
  }

  bool aligns_fw1() const {
    return _fw.aligns_tig1();
  }
  bool aligns_bw1() const {
    return _bw.aligns_tig1();
  }

  bool aligns_fw2() const {
    return _fw.aligns_tig2();
  }
  bool aligns_bw2() const {
    return _bw.aligns_tig2();
  }
  ...
  bool bridges_fw0_bw0()  const {
    return !_fw.aligns()       &&  !_bw.aligns();
  }
  bool bridges_fw0_bw1()  const {
    return !_fw.aligns()       &&   _bw.aligns_tig1();
  }
  bool bridges_fw0_bw2()  const {
    return !_fw.aligns()       &&   _bw.aligns_tig2();
  }

  bool bridges_fw1_bw0()  const {
    return  _fw.aligns_tig1()  &&  !_bw.aligns();
  }
  bool bridges_fw1_bw1()  const {
    return  _fw.aligns_tig1()  &&   _bw.aligns_tig1();
  }
  bool bridges_fw1_bw2()  const {
    return  _fw.aligns_tig1()  &&   _bw.aligns_tig2();
  }

  bool bridges_fw2_bw0()  const {
    return  _fw.aligns_tig2()  &&  !_bw.aligns();
  }
  bool bridges_fw2_bw1()  const {
    return  _fw.aligns_tig2()  &&   _bw.aligns_tig1();
  }
  bool bridges_fw2_bw2()  const {
    return  _fw.aligns_tig2()  &&   _bw.aligns_tig2();
  }

  bool bridges_fw01_bw1() const {
    return !_fw.aligns_tig2()  &&   _bw.aligns_tig1();
  }
  bool bridges_fw02_bw2() const {
    return !_fw.aligns_tig1()  &&   _bw.aligns_tig2();
  }

  bool bridges_fw1_bw01() const {
    return  _fw.aligns_tig1()  &&   !_bw.aligns_tig2();
  }
  bool bridges_fw2_bw02() const {
    return  _fw.aligns_tig2()  &&   !_bw.aligns_tig1();
  }
